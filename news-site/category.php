            ...
            <div class="col-md-8">
                ...
                <?php
                            ...
                            $res1 = mysqli_query($conn,$sql1) or die("query failed");
                             ...
                             $offset = ($pg-1)*6; 
                            $sql = "SELECT post_id, title, post_img, description, post_date, username, category_name, user_id FROM post LEFT JOIN user
                             ON post.author=user.user_id LEFT JOIN category ON post.category=category.category_id WHERE category=$cat_id LIMIT $offset,6";
                  ...
                  <?php
                    if($pg!=1)
                    {
                      echo '<li><a href="category.php?pg='.($pg-1).'&&cat_id='.$cat_id.'&&category='.$category.'"><<</a><li>';
                    }
                    for($i=1;$i<=$num_of_page;$i++)
                                   {
                                    ...
                                    $active = "";
                            ?>
                    <li class="<?php echo $active;?>"><a href="category.php?pg=<?php echo $i;?>&&cat_id=<?php echo $cat_id;?>&&category=<?php echo $category;?>"><?php echo $i; ?></a></li>
